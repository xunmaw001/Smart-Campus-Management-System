	...
	<view class="container">
		...
		<view class="">
			...
			<view class="yinyuewai">
				...
				<view class="xiangqing" @tap="download(baseUrl+detail.kechengFile)">
					<view class="shangpinxiangqing">
						<view class="box">
							课件：
						</view>
						<view class="app">
							<text class="text" :style='{"color":"#333","textAlign":"left","fontSize":"28rpx"}'>下载</view>
						</view>
					</view>
				</view>
					<view class="xiangqing">
		...
		export default {
			...
			methods: {
				...
				async init() {
					...
					this.detail.kechengContent = this.detail.kechengContent.replace("<img","<img  class=\"daxiao\"").replace("src=\"upload/","src=\""+this.$base.url+"upload/");
					// 主图
