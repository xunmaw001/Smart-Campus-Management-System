	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <button
                    ...
                    v-if="isAuth('yonghuKaoqinList','新增')" @click="onAddTap()" class="uniui-add">新增</button>
		</view>
	</view>
        ...
        <view style="padding: 0 20rpx;width: 100%;margin: 0 auto;;flex-direction: column;flex-wrap: wrap;flex-direction: row;margin-top: 0upx;">
            <view class="list b-b" v-for="(item, index) in list" :key="index" style="width:100%;height: auto;border: 1rps solid #999;margin: 0 auto;background-color: #FFFFFF;margin-top: 10rpx; box-shadow: 0  0 10rpx 0 #999999;border-radius: 25rpx;">
                <view
                    ...
                    <h4>{{ item.yonghuKaoqinListName }}</h4>
                    <view>
            ...
            <view style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;font-size: 12rpx;color: #8799A3;">
                ...
                <uni-icons v-show="isAuth('yonghuKaoqinList','修改')" @tap="onUpdateTap(item.id)" type="compose" size="20">
                </uni-icons>
	...
	export default {
		...
		async onShow() {
            ...
            _this.btnColor = _this.btnColor.sort(() => {
		  	...
		  	let yonghuKaoqinListTypes = await this.$api.page('dictionary', {
			 	 page: 1,
			  	limit: 100,
		  		dicCode:'yonghu_kaoqin_list_types'
		  	});
		  	this.yonghuKaoqinListTypesList = yonghuKaoqinListTypes.data.list;
			yonghuKaoqinListTypes.data.list.splice(0, 0, {codeIndex: 0, indexName: '全部'})
            this.categoryList = yonghuKaoqinListTypes.data.list
