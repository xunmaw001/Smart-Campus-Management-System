	...
	<view style="">
            <uni-drawer ref="showRight" mode="left" :maskClick="true" :width="100" :mask-click="true">
                <scroll-view scroll-y="true" class="tabView" :style='{"padding":"0","boxShadow":"0 0 12rpx rgba(255,0,0,0)","margin":"10rpx 0 0 ","borderColor":"rgba(0,0,0,1)","borderRadius":"0","borderWidth":"0","width":"150rpx","borderStyle":"solid","height":"auto"}'>
                    <view style="display: flex;flex-direction: column;">
                        <view :style='jiaoshiTypes===item.codeIndex?sactiveItem:sitem' class="tab"
                              v-for="(item,index) in jiaoshiTypesList" :key="index"
                              :class="jiaoshiTypes===item.codeIndex?'tabActive':''"
                              @tap="jiaoshiTypesCategoryClick(item.codeIndex)">{{item.indexName}}</view>
                    </view>
                </scroll-view>
            </uni-drawer>
        <view style="padding: 0 20rpx;width: 100%;margin: 0 auto;;flex-direction: column;flex-wrap: wrap;flex-direction: row;margin-top: 0upx;">
            <view class="list b-b" v-for="(item, index) in list" :key="index" style="width:100%;height: auto;border: 1rps solid #999;margin: 0 auto;background-color: #FFFFFF;margin-top: 10rpx; box-shadow: 0  0 10rpx 0 #999999;border-radius: 25rpx;">
                ...
                <!-- 级联表 -->
                <!-- 当前表 -->
                 <view v-show="item.jiaoshiValue" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                 ...
                 <view v-show="item.jiaoshiShichang" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                     <text style="width: 25%;margin-right: 5%;">工作时长</text>
                     <text style="width: 70%">
                         <text v-if="item.jiaoshiShichang != null">{{item.jiaoshiShichang}}</text>
                         <text v-else></text>
                     </text>
                 </view>
                ...
                <view v-show="item.jiaoshiContent" style="display: flex;justify-content: space-between;align-items: center;margin-top: 15rpx;">
                    <text style="width: 25%;margin-right: 5%;">教师简介</text>
                    <view style="width: 70%" v-html="item.jiaoshiContent"></view>
                </view>
...
<script>
	export default {
		...
		methods: {
            ...
            //当前表的 教师类型字段类别搜索
			jiaoshiTypesCategoryClick(categoryName) {
			...
			async upCallback(mescroll) {
                ...
                if (this.jiaoshiTypes != 0) {
                    params.jiaoshiTypes = this.jiaoshiTypes
                }
                let _this = this
