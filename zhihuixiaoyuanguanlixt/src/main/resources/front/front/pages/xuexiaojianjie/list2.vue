	...
	<view class="cu-bar bg-white search" :style="[{top:CustomBar + 'px'}]">
        ...
        <view class="action">
            ...
            <button
                    ...
                    v-if="isAuth('xuexiaojianjie','新增')" @click="onAddTap()" class="uniui-add">新增</button>
		</view>
	</view>
...
<script>
	export default {
		...
		async onShow() {
            ...
            this.categoryList = xuexiaojianjieTypes.data.list
				...
				let params = {
					...
					limit: mescroll.size
							...
							if (this.categoryName != 0) {
                                params.xuexiaojianjieTypes = this.categoryName
                            }
