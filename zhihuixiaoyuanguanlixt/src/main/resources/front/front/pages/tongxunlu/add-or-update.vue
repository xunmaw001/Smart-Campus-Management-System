        ...
        <form class="app-update-pv">
            <view
                ...
                <input   disabled
                         ...
                         :disabled="ro.tongxunluName" type="text" v-model="ruleForm.tongxunluName" placeholder="联系人名称"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">联系人方式</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                         :disabled="ro.tongxunluPhone" type="text" v-model="ruleForm.tongxunluPhone" placeholder="联系人方式"></input>
            </view>
            <view
                    :style='{"boxShadow":"0","backgroundColor":"rgba(255, 255, 255, 0.25)","borderColor":"rgba(228, 232, 230, 1)","margin":"0 0 0px 0","borderWidth":"2rpx","borderStyle":"none none solid none ","height":"100rpx"}'
                    class="cu-form-group">
                <view :style='{"width":"160rpx","fontSize":"28rpx","color":"var(--publicMainColor)","textAlign":"left"}'
                      class="title">联系人身份</view>
                <input   disabled
                         :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx"}'
                         :disabled="ro.tongxunluShenfen" type="text" v-model="ruleForm.tongxunluShenfen" placeholder="联系人身份"></input>
            </view>
<!-- text后缀 -->
            <view
                ...
                <textarea :style='{"padding":"0 24rpx","boxShadow":"0px 0px 0px rgba(0, 0, 0, 0.16)","margin":"0","borderColor":"var(--publicMainColor)","backgroundColor":"#fff","color":"#333","textAlign":"left","borderRadius":"0 180rpx 180rpx 0","borderWidth":"4rpx","fontSize":"28rpx","borderStyle":"solid","height":"88rpx","height":"200rpx"}'
                          :disabled="ro.tongxunluContent" v-model="ruleForm.tongxunluContent" placeholder="备注"/>
            </view>
    ...
    export default {
        ...
        async onLoad(options) {
            ...
            if (options.id) {
                ...
                // 获取信息
                let res = await this.$api.info(`tongxunlu`, this.ruleForm.id);
                this.ruleForm = res.data;
            }
            if(options.tongxunluId){
                this.ruleForm.tongxunluId = options.tongxunluId;
            }
            // 跨表
            // this.styleChange()
        },
        methods: {
            ...
            async onSubmitTap() {
				if ((!this.ruleForm.tongxunluName)) {
                    this.$utils.msg(`联系人名称不能为空`);
                    return
                }
				if ((!this.ruleForm.tongxunluPhone) && (!this.$validate.isMobile(this.ruleForm.tongxunluPhone))) {
                    this.$utils.msg(`联系人方式不能为空并且需要输入正确格式`);
                    return
                }
				if ((!this.ruleForm.tongxunluShenfen)) {
                    this.$utils.msg(`联系人身份不能为空`);
                    return
                }
                if (this.ruleForm.id) {
                    await this.$api.update(`tongxunlu`, this.ruleForm);
                } else {
                    await this.$api.save(`tongxunlu`, this.ruleForm);
                }
