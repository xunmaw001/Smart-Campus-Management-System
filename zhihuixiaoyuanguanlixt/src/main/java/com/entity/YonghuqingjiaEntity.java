...
public class YonghuqingjiaEntity<T> implements Serializable {
    ...
    @TableField(value = "yonghuqingjia_name")

    private String yonghuqingjiaName;
	 ...
	 * 获取：请假标题
	 */
    public String getYonghuqingjiaName() {
        return yonghuqingjiaName;
    }
    /**
	 * 设置：请假标题
	 */

    public void setYonghuqingjiaName(String yonghuqingjiaName) {
        this.yonghuqingjiaName = yonghuqingjiaName;
    }
    /**
	 * 获取：请假缘由
	 */
    ...
    public String toString() {
        return "Yonghuqingjia{" +
            ", id=" + id +
            ", yonghuId=" + yonghuId +
            ", yonghuqingjiaName=" + yonghuqingjiaName +
