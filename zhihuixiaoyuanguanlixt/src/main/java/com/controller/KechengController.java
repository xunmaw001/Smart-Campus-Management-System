...
//                            kechengEntity.setKemuTypes(Integer.valueOf(data.get(0)));   //科目 要改的
//                            kechengEntity.setBanjiTypes(Integer.valueOf(data.get(0)));   //星期 要改的
//                            kechengEntity.setJiaoshiId(Integer.valueOf(data.get(0)));   //上传教师 要改的
